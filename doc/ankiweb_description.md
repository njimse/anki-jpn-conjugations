...
Please see the [Release Notes in GitHub](https://github.com/njimse/anki-jpn-conjugations/blob/v1.3.0/doc/release_notes.md) for details on changes in this version as well as previous versions.
