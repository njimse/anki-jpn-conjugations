...
COMBO_HASHES = {
    ...
    (Formality.PLAIN, Form.VOLITIONAL): 'n6Nx',
    ...
    (Formality.POLITE, Form.CAUSATIVE_NON_PAST): 'Nq7Z',
    (Formality.POLITE, Form.CAUSATIVE_NON_PAST_NEG): 'Xr2M',
    (Formality.POLITE, Form.CAUSATIVE_PAST): 'Tv9K',
    (Formality.POLITE, Form.CAUSATIVE_PAST_NEG): 'Wb4P',
    (None, Form.CAUSATIVE_TE): 'Ly6D',
    (Formality.PLAIN, Form.CAUSATIVE_NON_PAST): 'Hs3F',
    (Formality.PLAIN, Form.CAUSATIVE_NON_PAST_NEG): 'Qm8J',
    (Formality.PLAIN, Form.CAUSATIVE_PAST): 'Zn5C',
    (Formality.PLAIN, Form.CAUSATIVE_PAST_NEG): 'Rk1V',
    (Formality.POLITE, Form.CAUSATIVE_PASSIVE_NON_PAST): 'Bd4T',
    (Formality.POLITE, Form.CAUSATIVE_PASSIVE_NON_PAST_NEG): 'Gp2W',
    (Formality.POLITE, Form.CAUSATIVE_PASSIVE_PAST): 'Ju7X',
    (Formality.POLITE, Form.CAUSATIVE_PASSIVE_PAST_NEG): 'Cf9M',
    (None, Form.CAUSATIVE_PASSIVE_TE): 'Ax3Q',
    (Formality.PLAIN, Form.CAUSATIVE_PASSIVE_NON_PAST): 'Vt6K',
    (Formality.PLAIN, Form.CAUSATIVE_PASSIVE_NON_PAST_NEG): 'Ns8H',
    (Formality.PLAIN, Form.CAUSATIVE_PASSIVE_PAST): 'Dy1L',
    (Formality.PLAIN, Form.CAUSATIVE_PASSIVE_PAST_NEG): 'Wq5R',
...
VERB_COMBOS = [
    ...
    (Formality.PLAIN, Form.VOLITIONAL),
    ...
    (Formality.POLITE, Form.CAUSATIVE_NON_PAST),
    (Formality.POLITE, Form.CAUSATIVE_NON_PAST_NEG),
    (Formality.POLITE, Form.CAUSATIVE_PAST),
    (Formality.POLITE, Form.CAUSATIVE_PAST_NEG),
    (None, Form.CAUSATIVE_TE),
    (Formality.PLAIN, Form.CAUSATIVE_NON_PAST),
    (Formality.PLAIN, Form.CAUSATIVE_NON_PAST_NEG),
    (Formality.PLAIN, Form.CAUSATIVE_PAST),
    (Formality.PLAIN, Form.CAUSATIVE_PAST_NEG),
    (Formality.POLITE, Form.CAUSATIVE_PASSIVE_NON_PAST),
    (Formality.POLITE, Form.CAUSATIVE_PASSIVE_NON_PAST_NEG),
    (Formality.POLITE, Form.CAUSATIVE_PASSIVE_PAST),
    (Formality.POLITE, Form.CAUSATIVE_PASSIVE_PAST_NEG),
    (None, Form.CAUSATIVE_PASSIVE_TE),
    (Formality.PLAIN, Form.CAUSATIVE_PASSIVE_NON_PAST),
    (Formality.PLAIN, Form.CAUSATIVE_PASSIVE_NON_PAST_NEG),
    (Formality.PLAIN, Form.CAUSATIVE_PASSIVE_PAST),
    (Formality.PLAIN, Form.CAUSATIVE_PASSIVE_PAST_NEG),
