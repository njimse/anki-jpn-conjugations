...
generate_verb_forms_data = [
    ('来[く]る', VerbClass.IRREGULAR, [
        ...
        # Polite Passive forms
        ['来[こ]られます', Form.PASSIVE_NON_PAST, Formality.POLITE],
        ['来[こ]られません', Form.PASSIVE_NON_PAST_NEG, Formality.POLITE],
        ['来[こ]られました', Form.PASSIVE_PAST, Formality.POLITE],
        ['来[こ]られませんでした', Form.PASSIVE_PAST_NEG, Formality.POLITE],
        # Plain Passive forms
        ['来[こ]られる', Form.PASSIVE_NON_PAST, Formality.PLAIN],
        ['来[こ]られない', Form.PASSIVE_NON_PAST_NEG, Formality.PLAIN],
        ['来[こ]られた', Form.PASSIVE_PAST, Formality.PLAIN],
        ['来[こ]られなかった', Form.PASSIVE_PAST_NEG, Formality.PLAIN],
        # formality-constant Potential
        ['来[こ]られて', Form.PASSIVE_TE, None],
        # Polite Causative forms
        ['来[こ]させます', Form.CAUSATIVE_NON_PAST, Formality.POLITE],
        ['来[こ]させません', Form.CAUSATIVE_NON_PAST_NEG, Formality.POLITE],
        ['来[こ]させました', Form.CAUSATIVE_PAST, Formality.POLITE],
        ['来[こ]させませんでした', Form.CAUSATIVE_PAST_NEG, Formality.POLITE],
        # Plain Causative forms
        ['来[こ]させる', Form.CAUSATIVE_NON_PAST, Formality.PLAIN],
        ['来[こ]させない', Form.CAUSATIVE_NON_PAST_NEG, Formality.PLAIN],
        ['来[こ]させた', Form.CAUSATIVE_PAST, Formality.PLAIN],
    ...
    ('食[た]べる', VerbClass.ICHIDAN, [
        ...
        # Passive forms
        # Polite forms
        ['食[た]べられます', Form.PASSIVE_NON_PAST, Formality.POLITE],
        ['食[た]べられません', Form.PASSIVE_NON_PAST_NEG, Formality.POLITE],
        ['食[た]べられました', Form.PASSIVE_PAST, Formality.POLITE],
        ['食[た]べられませんでした', Form.PASSIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['食[た]べられる', Form.PASSIVE_NON_PAST, Formality.PLAIN],
        ['食[た]べられない', Form.PASSIVE_NON_PAST_NEG, Formality.PLAIN],
        ['食[た]べられた', Form.PASSIVE_PAST, Formality.PLAIN],
        ['食[た]べられなかった', Form.PASSIVE_PAST_NEG, Formality.PLAIN],
        # formality-constant
        ['食[た]べられて', Form.PASSIVE_TE, None],

        # Causative forms
        # Polite forms
        ['食[た]べさせます', Form.CAUSATIVE_NON_PAST, Formality.POLITE],
        ['食[た]べさせません', Form.CAUSATIVE_NON_PAST_NEG, Formality.POLITE],
        ['食[た]べさせました', Form.CAUSATIVE_PAST, Formality.POLITE],
        ['食[た]べさせませんでした', Form.CAUSATIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['食[た]べさせる', Form.CAUSATIVE_NON_PAST, Formality.PLAIN],
        ['食[た]べさせない', Form.CAUSATIVE_NON_PAST_NEG, Formality.PLAIN],
        ['食[た]べさせた', Form.CAUSATIVE_PAST, Formality.PLAIN],
    ...
    ('切[き]る', VerbClass.GODAN, [
        ...
        # Passive forms
        # Polite forms
        ['切[き]られます', Form.PASSIVE_NON_PAST, Formality.POLITE],
        ['切[き]られません', Form.PASSIVE_NON_PAST_NEG, Formality.POLITE],
        ['切[き]られました', Form.PASSIVE_PAST, Formality.POLITE],
        ['切[き]られませんでした', Form.PASSIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['切[き]られる', Form.PASSIVE_NON_PAST, Formality.PLAIN],
        ['切[き]られない', Form.PASSIVE_NON_PAST_NEG, Formality.PLAIN],
        ['切[き]られた', Form.PASSIVE_PAST, Formality.PLAIN],
        ['切[き]られなかった', Form.PASSIVE_PAST_NEG, Formality.PLAIN],
        # formality-constant
        ['切[き]られて', Form.PASSIVE_TE, None],

        # Causative forms
        # Polite forms
        ['切[き]らせます', Form.CAUSATIVE_NON_PAST, Formality.POLITE],
        ['切[き]らせません', Form.CAUSATIVE_NON_PAST_NEG, Formality.POLITE],
        ['切[き]らせました', Form.CAUSATIVE_PAST, Formality.POLITE],
        ['切[き]らせませんでした', Form.CAUSATIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['切[き]らせる', Form.CAUSATIVE_NON_PAST, Formality.PLAIN],
        ['切[き]らせない', Form.CAUSATIVE_NON_PAST_NEG, Formality.PLAIN],
        ['切[き]らせた', Form.CAUSATIVE_PAST, Formality.PLAIN],
        ['切[き]らせなかった', Form.CAUSATIVE_PAST_NEG, Formality.PLAIN],
        # formality-constant
    ...
    ('下[くだ]さる', VerbClass.IRREGULAR, [
        ...
        # Passive forms
        # Polite forms
        ['下[くだ]さられます', Form.PASSIVE_NON_PAST, Formality.POLITE],
        ['下[くだ]さられません', Form.PASSIVE_NON_PAST_NEG, Formality.POLITE],
        ['下[くだ]さられました', Form.PASSIVE_PAST, Formality.POLITE],
        ['下[くだ]さられませんでした', Form.PASSIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['下[くだ]さられる', Form.PASSIVE_NON_PAST, Formality.PLAIN],
        ['下[くだ]さられない', Form.PASSIVE_NON_PAST_NEG, Formality.PLAIN],
        ['下[くだ]さられた', Form.PASSIVE_PAST, Formality.PLAIN],
        ['下[くだ]さられなかった', Form.PASSIVE_PAST_NEG, Formality.PLAIN],
        # formality-constant
        ['下[くだ]さられて', Form.PASSIVE_TE, None],

        # Causative forms
        # Polite forms
        ['下[くだ]さらせます', Form.CAUSATIVE_NON_PAST, Formality.POLITE],
        ['下[くだ]さらせません', Form.CAUSATIVE_NON_PAST_NEG, Formality.POLITE],
        ['下[くだ]さらせました', Form.CAUSATIVE_PAST, Formality.POLITE],
        ['下[くだ]さらせませんでした', Form.CAUSATIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['下[くだ]さらせる', Form.CAUSATIVE_NON_PAST, Formality.PLAIN],
        ['下[くだ]さらせない', Form.CAUSATIVE_NON_PAST_NEG, Formality.PLAIN],
        ['下[くだ]さらせた', Form.CAUSATIVE_PAST, Formality.PLAIN],
    ...
    ('なさる', VerbClass.IRREGULAR, [
        ...
        # Passive forms
        # Polite forms
        ['なさられます', Form.PASSIVE_NON_PAST, Formality.POLITE],
        ['なさられません', Form.PASSIVE_NON_PAST_NEG, Formality.POLITE],
        ['なさられました', Form.PASSIVE_PAST, Formality.POLITE],
        ['なさられませんでした', Form.PASSIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['なさられる', Form.PASSIVE_NON_PAST, Formality.PLAIN],
        ['なさられない', Form.PASSIVE_NON_PAST_NEG, Formality.PLAIN],
        ['なさられた', Form.PASSIVE_PAST, Formality.PLAIN],
        ['なさられなかった', Form.PASSIVE_PAST_NEG, Formality.PLAIN],
        # formality-constant
        ['なさられて', Form.PASSIVE_TE, None],

        # Causative forms
        # Polite forms
        ['なさらせます', Form.CAUSATIVE_NON_PAST, Formality.POLITE],
        ['なさらせません', Form.CAUSATIVE_NON_PAST_NEG, Formality.POLITE],
        ['なさらせました', Form.CAUSATIVE_PAST, Formality.POLITE],
        ['なさらせませんでした', Form.CAUSATIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['なさらせる', Form.CAUSATIVE_NON_PAST, Formality.PLAIN],
        ['なさらせない', Form.CAUSATIVE_NON_PAST_NEG, Formality.PLAIN],
        ['なさらせた', Form.CAUSATIVE_PAST, Formality.PLAIN],
        ['なさらせなかった', Form.CAUSATIVE_PAST_NEG, Formality.PLAIN],
        # formality-constant
    ...
    ('いらっしゃる', VerbClass.IRREGULAR, [
        ...
        # Passive forms
        # Polite forms
        ['いらっしゃられます', Form.PASSIVE_NON_PAST, Formality.POLITE],
        ['いらっしゃられません', Form.PASSIVE_NON_PAST_NEG, Formality.POLITE],
        ['いらっしゃられました', Form.PASSIVE_PAST, Formality.POLITE],
        ['いらっしゃられませんでした', Form.PASSIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['いらっしゃられる', Form.PASSIVE_NON_PAST, Formality.PLAIN],
        ['いらっしゃられない', Form.PASSIVE_NON_PAST_NEG, Formality.PLAIN],
        ['いらっしゃられた', Form.PASSIVE_PAST, Formality.PLAIN],
        ['いらっしゃられなかった', Form.PASSIVE_PAST_NEG, Formality.PLAIN],
        # formality-constant
        ['いらっしゃられて', Form.PASSIVE_TE, None],

        # Causative forms
        # Polite forms
        ['いらっしゃらせます', Form.CAUSATIVE_NON_PAST, Formality.POLITE],
        ['いらっしゃらせません', Form.CAUSATIVE_NON_PAST_NEG, Formality.POLITE],
        ['いらっしゃらせました', Form.CAUSATIVE_PAST, Formality.POLITE],
        ['いらっしゃらせませんでした', Form.CAUSATIVE_PAST_NEG, Formality.POLITE],
        # Plain forms
        ['いらっしゃらせる', Form.CAUSATIVE_NON_PAST, Formality.PLAIN],
        ['いらっしゃらせない', Form.CAUSATIVE_NON_PAST_NEG, Formality.PLAIN],
        ['いらっしゃらせた', Form.CAUSATIVE_PAST, Formality.PLAIN],
